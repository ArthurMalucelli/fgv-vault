...
data: 2026-06-12
tema: Prova final, resumo cumulativo do semestre
tags: [resumo, prova]
---

# Prova Final CDC, 12.06 13h00
...
| Marca | Conta | Score |
|---|---|---|
| Kopenhagen | 4(9) + 9(9) + 7(10) + 10(9) | **277** ← escolhida |
...
1. **Razão variável é o esquema MAIS resistente à extinção**, com alta taxa de resposta (caça-níquel, gamificação). Alternativa dizendo que gera "menor resistência" está errada. Intervalo = tempo; razão/proporção = número de respostas. Não são equivalentes.
2. **Reforço negativo ≠ punição.** Reforço negativo fortalece o comportamento por evitação de algo ruim; punição enfraquece o comportamento.
3. **Conjuntiva vs disjuntiva vs lexicográfica vs EBA**: corte em todos / excelente em um / melhor no critério nº1 / cortes na ordem de importância. Conjuntiva seguida de "escolho o melhor em X" = conjuntiva + lexicográfica (questão 2 do quiz). Mnemônica de lógica: **conjuntiva = AND** (tem que passar em todos os cortes), **disjuntiva = OR** (basta nota máxima em um critério-chave). ⚠️ Errei no simulado: filtro por "excelente em pelo menos um" é DISJUNTIVA, não conjuntiva.
4. **Lei de Weber: j.n.d. é PROPORCIONAL ao estímulo original (ΔI/I = k)**, nunca "constante absoluta".
5. **Subliminar existe como fenômeno, mas a eficácia comercial NÃO é comprovada.** Alternativa com "amplamente comprovada" é falsa.
6. **Hierarquias de atitude: a ordem dos componentes é a resposta.** Pesquisa extensa antes = padrão (C→A→B). Impulso que vira afeto e recomendação = dissonância-atribuição (B→A→C). Rotina barata com atitude fraca só após uso = baixo envolvimento. Emoção puxando = experiencial (A→B→C). Teste do tempo do afeto: "adorou AO USAR", "descobriu depois que gosta" = afeto PÓS-compra = dissonância-atribuição, nunca experiencial. Experiencial exige a emoção como motor ANTES da compra (show, perfume, hedônico). ⚠️ Errei no simulado: impulso de vitrine + amar depois ≠ experiencial.
7. **Conflito aproximação-evitação = mesmo objeto com valência positiva E negativa** (carro: estima nível 4 vs segurança nível 2 de Maslow). Duas opções boas = aproximação-aproximação. Duas ruins = evitação-evitação. Motivação hedônica e utilitária **podem coexistir**.
8. **Críticas a Maslow caem**: produto satisfaz várias necessidades, ordem depende da cultura, base empírica fraca.
9. **"Qualidade" sozinha não é atributo** no modelo multiatributo: atributo tem que ser específico (doçura, amargor). Percepção de qualidade (ranking mental) pode entrar.
10. **Fila, distância e distribuição física não entram no modelo de atitudes**: são circunstância, não atributo da marca.
11. **Notas e pesos do Fishbein vêm de pesquisa com consumidores reais da categoria**, nunca de opinião interna da diretoria.
12. **Categoria não é o produto físico**: chocolate fino é categoria de presente, então Cacau Show concorre com Boticário.
13. **Pesquisa não motivada (espontânea) revela o conjunto de consideração real**; com lista, enviesa ([[Pesquisa top of mind]]).
14. **Lealdade ≠ inércia**: lealdade = recompra com atitude forte; inércia = recompra por preguiça, vulnerável a qualquer promoção.
15. **Familiaridade extrema pode REDUZIR recall** (deixa de prestar atenção). Marca pioneira e estímulo destoante (Von Restorff) melhoram recall.
16. **Atitude não prevê comportamento direto** ([[Gap atitude-comportamento]]).
17. **Nudge não pode mudar incentivo econômico nem proibir**: multa, imposto, subsídio não são nudge; default de doação de órgãos é.
18. **Vigilância perceptiva** (notar o relevante) vs **defesa perceptiva** (bloquear o ameaçador): os dois são seleção pessoal.
19. **Miopia em marketing = definir o ramo pelo produto.** Resposta certa sempre aponta pra necessidade do cliente.
20. **Risco social (julgamento externo) ≠ risco psicológico (culpa interna).** Streaming barato: risco físico não se aplica.
21. **Redução de risco age na avaliação de alternativas**, não na busca de informação (tráfego não é conversão).

## Pra fixar

- [[Lei de Weber]] · [[Percepção Subliminar]] · [[Gestalt]]
- [[Condicionamento Clássico]] · [[Condicionamento Operante]] · [[Efeito Halo]] · [[Aprendizagem observacional]]
- [[Pirâmide de Maslow]] · [[Conflitos Motivacionais]] · [[Envolvimento]]
- [[Atitudes]] · [[Modelo CAB]] · [[Modelo de Fishbein]] · [[Mapa perceptual]] · [[Nudge]]
