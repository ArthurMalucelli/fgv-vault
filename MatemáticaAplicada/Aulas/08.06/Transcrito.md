...
*Lacuna (00:24 a 00:28): a passagem pelos cinco casos de função potencial (n par positivo, ímpar positivo, par negativo, ímpar negativo, racional) não foi capturada. Os cinco casos com domínio estão na tua anotação [[Limites - Introdução]] e na tabela do [[Resumo]].*
...
*Fim do áudio recuperável (01:18). Propriedades operatórias de limites (soma, produto, quociente, potência, raiz, ln) estão nos slides 6 e 7 e condensadas no [[Resumo]].*
